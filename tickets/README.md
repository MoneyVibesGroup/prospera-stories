...
| `TICKET-FRONTEND-regeneration-types-cima-story-292.md` *(doublon de ligne, voir ci-dessus)* | frontend | **STORY-292** à la livraison (vivianMoneyVibesGroupes, 10/08) | ➡️ **repris par AP-28 le 15/08** — `REFERENTIELS_BALANCE` gagne `CIMA` côté backend (additif) ; les types générés côté front restent figés à 3 valeurs tant qu'ils ne sont pas régénérés depuis l'`openapi.json` de `balance-service` |
...
| `TICKET-FRONTEND-regeneration-types-cima-story-292.md` | frontend | STORY-292 (10/08) | ➡️ **REPRIS le 15/08 par AP-28** (sprint 9, 2 pts) — remplace l'entrée « ⛔ ouvert » ci-dessus. AP-28 fait foi |
