# Story FE-030 : Table de passage + arbitrage comptes non mappés + surcharges + référentiel
...
**Backend prêt :** S11
**Dépendances :** FE-027 (balance canonique produite par l'Atelier, consultable)
...
- **Garde de validation** : indiquer que la liasse ne pourra être validée tant que des comptes **significatifs** restent non mappés (relié à FE-034).
...
- [ ] Message clair : comptes significatifs non mappés = blocage de la validation (cohérent FE-034).
...
- [ ] Commits sur `fe-030`, préfixés `FE-030`.
