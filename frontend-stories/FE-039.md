...
Status: **SUPERSEDED** — fusionnee dans **FE-069** le 2026-08-14

> ## SUPERSEDED le 2026-08-14 — ne pas developper cette story
>
> **Fusionnee dans [FE-069](FE-069.md) (« e2e du parcours cabinet complet »), sprint 13,
> qui passe de 5 a 8 points pour l'absorber.**
>
> Les deux e2e se recouvraient sur tout leur milieu : `balance -> liasse -> validation -> export`
> (FE-039) et `creer un dossier -> le tenir -> l'archiver` (FE-069). Depuis la reorganisation du
> 2026-08-14, **le parcours Bilan est un SEGMENT du parcours dossier** — il ne peut plus se jouer
> hors d'un dossier, puisque le Bilan naît dossier-scope (FE-028 re-specifiee).
>
> Maintenir deux e2e qui traversent le meme chemin les aurait fait diverger. La fusion rend 2 points
> et supprime cette divergence. Les exigences a11y / i18n / durcissement de FE-039 sont reprises
> telles quelles dans FE-069, **qui est la seule source de verite**.
