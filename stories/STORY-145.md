# STORY-145 : `platform-catalog-service` — le référentiel devient conditionnel au module (`referentielFamilies` au catalogue, référentiel optionnel sur l'entitlement)
...
**Hors périmètre :**
- Le dépôt d'artefact de référentiel — c'est **STORY-146**.
