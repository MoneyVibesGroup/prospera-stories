# STORY-600 : Le journal à deux acteurs — un acte délégué se lit chez le client, et il nomme Money Vibes
...
**Points :** 5 · **Sprint :** S32 *(proposé — se tire avec STORY-599, qu'elle conditionne)*
**Prérequis :** **STORY-599** (les contrôleurs d'administration)
...
STORY-599 ouvre la délégation. **Sans cette story-ci, elle est inacceptable** — et le défaut ne
...
- Voir [[STORY-599]], [[STORY-240]] (journal chaîné + outbox), [[STORY-166]], [[STORY-167]],
