...
7. Portes DoD : lint 0, build OK, couverture maintenue, **mutation-tests** sur chacun des trois
   sites rebranchés (retirer la garde ⇒ test rouge).
...
4. **Le scénario complet de bout en bout** : paramétrer une ventilation valide, saisir un cahier,
