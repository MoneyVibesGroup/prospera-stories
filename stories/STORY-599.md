# STORY-599 : Money Vibes agit POUR une organisation — contrôleurs d'administration, `orgId` explicite, et la liste blanche de ce qui est délégable
...
**Points :** 8 · **Sprint :** S32 *(proposé — se tire avec STORY-166/167, dont elle dépend)*
...
- [ ] AC-6 — Le **titulaire d'un compte d'encaissement n'est jamais pré-rempli avec Money Vibes**
      ...
      du client**.
- [ ] AC-7 — Chaque acte délégué émet l'entrée de journal de **STORY-600**. ⛔ Un acte délégable qui
...
- Voir [[STORY-166]], [[STORY-167]], [[STORY-600]], [[STORY-241]], [[STORY-243]], [[STORY-048]],
