...
STORY-400**. Périmètre backend uniquement ; le frontend suit sa série `FE-*` dans son tracker propre.
...
### STORY-400 — Scaffold `fiscal-service` (:3012), socle transverse et point de santé
...
### STORY-401 — Deux bases MongoDB et rôles restreints (`fiscal`, `fiscal_audit`)
...
### STORY-402 — Read-models locaux et gate `@RequiresFiscalAccess`
...
### STORY-403 — Chargeur de paquet fiscal depuis `catalog-service`
...
### STORY-404 — Statut de validation des éléments et rattachement version ↔ exercice
...
### STORY-405 — Journal d'audit chaîné par périmètre et outbox transactionnelle
...
### STORY-406 — Habilitations graduées et séparation des natures d'accès
...
### STORY-407 — Dossier fiscal, attestation de mandat et historisation
...
### STORY-408 — Implantations fiscales : création, type d'entité, clôture
...
### STORY-409 — Proposition et confirmation des régimes par implantation
...
### STORY-410 — Résolution conjointe type d'entité → référentiel et paquet
...
### STORY-411 — Dérivation du catalogue d'obligations
...
### STORY-412 — Activation et désactivation manuelle d'une obligation
...
### STORY-413 — Taxes sectorielles et échéances portées par le type d'entité
...
### STORY-414 — Régime dérogatoire et signalement
...
### STORY-415 — Agnosticisme de la source de balance
...
### STORY-416 — Registre de familles, famille proportionnelle et détail de calcul
...
### STORY-417 — Familles barème par tranches et forfait par tranche
...
### STORY-418 — Pipeline de modificateurs ordonné
...
### STORY-419 — Aiguillage, y compris sur l'état d'un tiers
...
### STORY-420 — Familles hors périmètre : déclarables, non calculables
...
### STORY-421 — Calendrier fiscal centralisé, filtres et tri
...
### STORY-422 — Calcul des échéances depuis le paquet
...
### STORY-423 — Reports d'échéance administratifs
...
### STORY-424 — Alertes d'échéance et états de retard
...
### STORY-425 — Responsable désigné et vue de charge par collaborateur
...
### STORY-426 — Alimentation depuis la balance et blocage motivé
...
### STORY-427 — Délégation du calcul au moteur de `balance-service`
...
### STORY-428 — Triplet calculé, déclaré, payé
...
### STORY-429 — Cycle de vie de l'obligation et rôles
...
### STORY-430 — Validation du client capturée comme pièce
...
### STORY-431 — Rectificatives versionnées, immuabilité et clôture
...
### STORY-432 — Contrôles de cohérence intra-période avec tolérances
...
### STORY-433 — Continuité inter-périodes
...
### STORY-434 — Anomalies : gravité, blocage et levée motivée
...
### STORY-435 — Restitution du chemin d'un montant et historique complet
...
### STORY-436 — Port de canal asynchrone et production du livrable
...
### STORY-437 — Format de canal décrit comme donnée du paquet
...
### STORY-438 — Guidage de dépôt pas à pas
...
### STORY-439 — Capture de l'accusé et qualification du retard
...
### STORY-441 — Archivage des livrables et accusés
...
### STORY-442 — Dossier de contrôle à la demande
...
### STORY-443 — Rapprochement des pièces justificatives, granularité annoncée
...
### STORY-444 — Liaison entre écriture comptable et pièce justificative
...
- **Étant donné** cette liaison disponible **quand** le rapprochement de STORY-443 s'exécute **alors** il peut descendre au niveau de la pièce.
...
### STORY-445 — Base légale citée verbatim sur chaque retraitement
...
### STORY-446 — Montant à régler net d'acomptes, crédits et retenues
...
### STORY-447 — Ordre de règlement produit, jamais exécuté
...
### STORY-448 — Rapprochement du règlement et refus d'imputation incohérente
...
### STORY-449 — Distinction « déposée » et « payée »
...
### STORY-450 — Estimation des pénalités et majorations comme risque
...
### STORY-451 — Base de rémunération par salarié et par période
...
### STORY-452 — Import d'un fichier de paie, idempotent et versionné
...
### STORY-453 — Saisie manuelle de la base de rémunération
...
### STORY-454 — Calcul des cotisations et des retenues sur salaires
...
### STORY-455 — Obligations sociales dans le calendrier, le cycle et la preuve
...
### STORY-456 — Rapprochement des charges sociales et des comptes de personnel
